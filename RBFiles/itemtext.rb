...
:TYPHCREST => {
	...
	:desc => "Typhlosion's Attack scales with Sp. Atk, and contact moves do an additional hit of damage.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
:REUNICREST => {
	...
	:desc => "Using Fighting- or Psychic-type moves swaps between respective types. Swaps attacking stats while Fighting-type.",
	:price => 0,
	:crest => true,
	:noUseInBattle => true,
	:noUse => true,
...
#Edited: moved HMs all the way to the bottom so that the TMs are in order
:HM01 => {
	:ID => 383,
	:name => "HM01",
